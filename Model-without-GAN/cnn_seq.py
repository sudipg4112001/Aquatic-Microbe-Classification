...
Original file is located at
    https://colab.research.google.com/drive/1TkCEgNGV06cprqgUr8OiNct2Bhs0f0lq
"""
...
model = Sequential()
model.add(Conv2D(16,(3,3),input_shape=(64,64,3),activation='selu'))
...
model.add(Conv2D(filters=256, kernel_size=(5, 5), activation='selu'))
...
history = model.fit(train_generator,steps_per_epoch = len(X_train)/64,
                                   epochs = 100,
                                   shuffle = False,
